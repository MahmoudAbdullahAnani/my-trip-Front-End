...
const Footer = () => {
  return (
    <footer
      dir="rtl"
      className="lg:px-[96px] px-[16px] relative z-10 text-[#FFF] bg-[#117C99] pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]"
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-5/12">
            <div className=" w-full">
              ...
              <p className="mb-7 text-base text-body-color dark:text-dark-6">
                هذا النص مجرد مثال فقط هذا النص مجرد مثال فقط هذا النص مجرد مثال
                فقط هذا النص مجرد مثال فقط هذا النص مجرد مثال فقط هذا النص مجرد
                مثال فقط هذا النص مجرد مثال فقط
              </p>
          ...
          <LinkGroup header="موارد">
            <NavLink link="/#" label="تطوير ادارة العلاقات مع" />
            <NavLink link="/#" label="منتجاتنا" />
            <NavLink link="/#" label="تدفق المستخدم" />
            <NavLink link="/#" label="استراتيجية المستخدم" />
          </LinkGroup>
          <LinkGroup header="شركة">
            <NavLink link="/#" label="حول اجواء" />
            <NavLink link="/#" label="اتصل بالدعم" />
            <NavLink link="/#" label="تاريخ النجاح" />
            <NavLink link="/#" label="الإعداد والخصوصية" />
          </LinkGroup>
          <LinkGroup header="روابط سريعة">
            <NavLink link="/#" label="دعم متميز" />
            <NavLink link="/#" label="خدماتنا" />
            <NavLink link="/#" label="تعرف على فريقنا" />
            <NavLink link="/#" label="تحميل التطبيق" />
          </LinkGroup>
