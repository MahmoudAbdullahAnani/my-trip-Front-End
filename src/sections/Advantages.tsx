          ...
          <div className="w-full">
            <div className="wow fadeInUp" data-wow-delay=".15s">
              ...
              <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                يتميز أسطولنا بتشكيلة واسعة من السيارات الموديلات الحديثة
                والمتنوعة لتلبية احتياجات جميع العملاء.
              </p>
            </div>
          </div>
          <div className="w-full">
            <div className="wow fadeInUp" data-wow-delay=".15s">
              ...
              <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                نقدم منصة حجز مبسطة وسهلة الاستخدام تتيح للعملاء حجز السيارات
                بسرعة ويسر في أي وقت ومن أي مكان.
              </p>
            </div>
          </div>
          <div className="w-full">
            <div className="wow fadeInUp" data-wow-delay=".15s">
              ...
              <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                فريق خدمة العملاء لدينا متواجد على مدار الساعة لتقديم المساعدة
                والدعم الفوري لجميع استفسارات العملاء.
              </p>
            </div>
          </div>
          <div className="w-full">
            <div className="wow fadeInUp" data-wow-delay=".15s">
              ...
              <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                نوفر عروضًا خاصة لعمليات التأجير طويلة الأمد للعملاء الشركات
                والأفراد بأسعار تنافسية وشروط مرنة.
              </p>
            </div>
          </div>
          <div className="w-full">
            <div className="wow fadeInUp" data-wow-delay=".15s">
              ...
              <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                نقدم خيارات تأمين شاملة للسيارات لضمان راحة العملاء وحمايتهم من
                المخاطر المحتملة أثناء فترة التأجير.
              </p>
            </div>
          </div>
          <div className="w-full">
            <div className="wow fadeInUp" data-wow-delay=".15s">
              ...
              <p className="pr-[10px] text-base font-medium leading-relaxed text-body-color">
                نوفر خدمة توصيل واستلام السيارات إلى ومن المطارات والفنادق
                والمواقع الأخرى، مما يوفر للعملاء راحة إضافية وتجربة مريحة.
              </p>
            </div>
          </div>
        </div>
