...
function BtnSearch() {
  ...
  return (
    <button
      ...
      className={`w-[177px] h-[47px] mt-2  rounded-[13px] bg-[#117C99] hover:bg-[#216678] text-[#FFF] hover:text-[#cfcfcf] duration-150 px-[68px] ml:text-[14.957px] ml:font-black text-[14px] font-[500] `}
      onClick={() =>
        console.log({
          locationFrom,
