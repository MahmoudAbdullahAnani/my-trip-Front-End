...
function ControlSystems() {
  ...
  return (
    <div className={`flex justify-end gap-[24px] `}>
      <div
      onClick={()=>setTypeSystemState("car")}
        style={{
        ...
        className={`${
          typeSystemState === "car"
            ? "text-[#117C99] text-[14px] font-[700]"
            : "text-[#4F4F4F] text-[12px] font-[600]"
        } text-center flex gap-[10px] h-[63px] w-[167px] cursor-pointer`}
      >
        التوصيل
        {typeSystemState === "car" ? (
          <svg
      ...
      <div
      onClick={()=>setTypeSystemState("hotel")}
              style={{
          fill: "rgba(182, 231, 251, 0.30)",
          strokeWidth: "1px",
          stroke: "#FFF",
      ...
      <div
      onClick={()=>setTypeSystemState("air")}
              style={{
          fill: "rgba(182, 231, 251, 0.30)",
          strokeWidth: "1px",
          stroke: "#FFF",
