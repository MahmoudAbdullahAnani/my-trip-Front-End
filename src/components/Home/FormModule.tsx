  ...
  return (
    <div className={`flex flex-col mx-5`}>
      ...
      <div
        ...
        className={`lg:pr-[106px] lg:pe-[82px] pr-[10px] sm:py-10 py-1 flex flex-col sm:gap-5 gap-1 xl:h-[calc(283px-(47px+.5rem))] sm:rounded-tl-[25px] rounded-t-[25px] border border-[#FFF] border-1 border-b-0  `}
      >
        {children}
      </div>
